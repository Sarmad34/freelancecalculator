...
const ToolIcons = [
  ...
  <svg key="6" className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 1v22m5-18H7a3 3 0 000 6h10a3 3 0 010 6H7" /></svg>
];
    ...
    <div className="w-full bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-16 pb-12 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          ...
          <Link to="/tax-take-home-estimator" className="px-10 py-5 bg-slate-900 text-white rounded-2xl font-bold shadow-2xl shadow-slate-200 hover:bg-slate-950 hover:-translate-y-1 transition-all active:scale-95 text-lg">
            Estimate Take-Home
          </Link>
        </div>
      </div>
